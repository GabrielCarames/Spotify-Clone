...
const Results = () => {
    ...
    return (
        <div className="results-container">
            ...
            {sections && console.log("sections", sections)}
            <div className="types-results-container">
                {
                                            ...
                                            return (
                                                <li className="list__item" key={id}>
                                                    <Link className="list__link" to={section.type !== 'artist' ? `/playlist/${section.id}` : '#/'} onClick={() => section.type === 'artist' && alert("Aún no disponible")}>
                                                        ...
                                                        <p className="list__artist-name">{section.name}</p>
                                                        <p className="list__type">{section.owner ? "De " + section.owner.display_name : "Artist"}</p>
                                                    </Link>
                                                </li>
                                            )
                                        })
